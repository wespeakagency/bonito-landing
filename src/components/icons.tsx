...
export const SpotifyIcon = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <title>Spotify</title>
    <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2m4.053 13.858c-.24.375-.72.5-1.095.24-2.88-1.755-6.51-2.13-10.845-1.155-.435.09-.84-.18-.93-.615-.09-.435.18-.84.615-.93 4.695-1.05 8.7-0.645 11.88 1.305.36.21.495.69.285 1.05m.12-2.325c-.27.45-.855.6-1.305.33-3.255-1.98-8.145-2.58-11.925-1.41-.51.15-.99-.15-1.14-.66-.15-.51.15-.99.66-1.14 4.215-1.29 9.585-0.645 13.26 1.575.45.27.6.855.33 1.305m.15-2.43C12.51 7.41 6.885 7.17 3.945 8.01c-.57.165-1.2-.165-1.365-.735-.165-.57.165-1.2.735-1.365 3.465-.945 9.765-.675 13.995 1.875.525.315.705 1.005.39 1.53-.315.525-1.005.705-1.53.39" />
  </svg>
);
