...
const spanishSpotifyShow = 'https://open.spotify.com/show/1ObwenjHOAGHVapd9V2y8B';

export const spotifyLinks: Record<Locale, string> = {
  es: spanishSpotifyShow,
  ...
  el: spanishSpotifyShow,
  it: spanishSpotifyShow,
};
